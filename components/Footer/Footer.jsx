...
const Footer = () => {
  return (
    <div className="bg-[#D6F2E6] w-full h-[400px] relative p-5 ">
      <div className="w-[100px] h-[270px] absolute bottom-0 sm_max:w-[90px] sm_max:h-[250px]  ">
        <Image src="/Images/LeafLeft.png" layout="fill" alt="leaf-left" />
      </div>
      <div className="w-[140px] h-[350px] absolute bottom-0 right-0 sm_max:w-[120px] sm_max:h-[300px]">
